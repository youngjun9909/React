...
import cat01 from '../../../images/cat01.jpg'
...
export function Img() {
  // 중괄호 내에서 HTML코드 작성 시 ()내에 작성
  return (
    <img src={cat01} alt="고양이" width={300} />
  )
}
...
export default function Component01() {
  ...
  return (
    <div>
      <p>고양이 이미지 - img태그 사용</p>
      <img src="images/cat01.jpg" alt="고양이" width={200} />
      <img src={cat01} alt="고양이" width={200} />


      <p>고양이 이미지 - img컴포넌트 사용</p>
      <Img />
      <Img />
      <Img />
      <Img />
